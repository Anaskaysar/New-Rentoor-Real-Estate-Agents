...
const ManageAllorders = () => {
    ...
    useEffect(() => {
        const url = `https://boiling-reef-11210.herokuapp.com/orders`
        fetch(url)
            .then(res => res.json())
                ...
                <Table sx={{}} aria-label="Appointments table">
                    <TableHead>
                         <TableRow>
                            ...
                            <StyledTableCell align="left">Status Update</StyledTableCell>
                    ...
                    <TableBody>
                        {orders.map((row) => (
                            <StyledTableRow key={row._id}>
                                ...
                                <StyledTableCell align="left"><Button >Confirm </Button></StyledTableCell>
